...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <p>
        The images above are 2 Profile components. You can reuse this component
        any time in the future by using the Profile tag.
      </p>

      <p>
        You can import a Component from any file. In the next case, I import the
        Gallery component from Gallery.js, which import Profile from Profile.js:
      </p>
      <Gallery></Gallery>
      ...
      <p>
        1. Return 1 root element - JSX tags are just JS components. If you want
        to return multiple elements, use a <i>Fragment</i> - like how I&apos;m
      ...
      <p>
        Props are information to pass to a JSX tag. For example, <i>img</i> can
        contain className, src, alt, width,...
      </p>

      <p>
        Props can also have default values. You can also have JSX as props (look
        at layout.js).
      </p>
      ...
      <Heading1>More rendering stuff - list and conditional rendering</Heading1>

      <p>
        These are more about <i>React official way </i>of doing these, you could
      ...
      <p>
        About lists - you could just use the JS <i>map()</i> method. Remember to
        get an unique and unchanging key for all elements in a list!
      </p>
